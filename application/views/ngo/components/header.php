...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tour/0.12.0/js/bootstrap-tour.js"></script>

<style>
.box-header>.box-tools{position: initial;}
.content_h_m_b{margin-bottom: 10px;}
</style>
<script>
