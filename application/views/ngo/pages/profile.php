...
<!-- Content Wrapper. Contains page content -->
	<div class="content-wrapper">
		...
		<section class="content">
			<div class="row">
				<input id="ngo_staff_id " value="<?php echo $profile_data['ngo_staff_id']; ?>"   type="hidden" class="ngo_staff_id " >
				<!-- left column -->
				<div class="col-md-12">
						...
						<form id="profile_update_form" method="post" role="form">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="first_name" name="first_name" placeholder="Name" value="<?php if($profile_data){ echo $profile_data['first_name']; } ?>">
								</div>
								<div class="form-group">
									<label for="last_name">Last Name</label>
									<input type="text" class="form-control" id="last_name" name="last_name" placeholder="Name" value="<?php if($profile_data){ echo $profile_data['last_name']; } ?>">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="number" class="form-control" id="staff_mobile" name="staff_mobile" placeholder="Mobile Number" value="<?php if($profile_data){ echo $profile_data['staff_mobile']; } ?>" />
								</div>
								<div class="form-group row">
									<div class="col-lg-4">
										<label class="control-label"  for="staff_profile_image">Profile Image</label><br>
										<button type="button" class="btn btn-primary btn-lg upload_image_click" id="upload_image_click"> <i class="fa fa-upload"></i> </button>
							...
							<div class="box-footer">
								<a href="<?php echo base_url();?>ngo/access/profile"><button type="button" class="btn btn-default " id="save_goto_next_step1">Cancel</button></a>
	...
	<?php $this->load->view('image_upload_croppie',$profile_data); ?>
 <script>
...
$('#profile_update_form').validate({
        ...
        submitHandler: function (form) {
            ...
            table_field={
              ...
              staff_mobile : $('#staff_mobile').val(),
            };
            $.post(APP_URL + 'ngo/access/update_profile_data', {
            ...
            function (response) {
                ...
                if (response.status == 200) {
               	...
               	$("#err_profile_update_form").fadeTo(2000, 500).slideUp(500, function(){
						$('#err_profile_update_form').empty();
						window.location.href = APP_URL+'ngo/access/profile';
					});
