         ...
         <div id="">
			<div class="panel panel-default">
				<div class="row panel-body">
					...
					<div class="form-group col-md-12" style="margin-bottom: -16px;margin-top: -8px;">
	...
	<div id="detail_of_foreign_travel_html">
		<div class="panel panel-default">
			<div class=" panel-body">
				<div class="form-group col-md-12" style="margin-bottom: -15px;margin-left: 14px;">
		...
		<div style="display: none;">
			<div id="detail_of_donor_html">
                <div id="">
					<div class="panel panel-default">
					    <div class=" panel-body">
							<div class="form-group col-md-12" style="margin-bottom: -14px;">
