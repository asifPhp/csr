...
<div class="login-box">
  <div class="login-logo">
    <a href="javascript:void(0);"><?php echo PROJECT_NAME_NGO;?></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form id="userLoginForm"  role="form" method="post">
      ...
      <div class="row" style="margin-left: 8px;">
        <div class="col-xs-8">
          <a href="<?php echo base_url();?>ngo/forgot">I forgot my password</a>
    ...
    <br>
    <a href="<?php echo base_url();?>ngo/register" class="text-center">Register a New NGO</a>
    ...
    $('#userLoginForm').validate({
		...
		rules: {
            loginUserEmail: {
                required: true,
                remote:{
                    url: APP_URL + "ngo/login/check_email_availability",
                    type: "post",
                    data: {
                        param: 'login',
                    }
        ...
        submitHandler: function (form) {
            ...
            $.post(APP_URL + 'ngo/login/check_login_credentials', {
                ...
                $('#err_login_form').empty();
               	if (response.status ==200) {
					...
					$("#err_login_form").fadeTo(1000, 500).slideUp(500, function(){
						$('#err_login_form').empty();
                        if(response.last_password_change){
						      window.location.href = APP_URL+'ngo/configure';
                        }else{
                            window.location.href = APP_URL+'ngo/login/change_password';
                        }
					});
