...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <a href="<?php echo base_url();?>organisation/forgot">I forgot my password</a><br>
...
$('document').ready(function () {
    ...
    $('#userLoginForm').validate({
        ...
        submitHandler: function (form) {
            ...
            $.post(APP_URL + 'organisation/login/check_login_credentials', {
               	...
               	if (response.status ==200) {
					...
					$("#err_login_form").fadeTo(1000, 500).slideUp(500, function(){
                        ...
                        if(response.last_password_change){
                            ...
                            window.location.href = APP_URL+'organisation/login/change_password';
                        }
					});
