								...
								<div class="box-body" >
									<form id="product" method="post" role="form">
										<div class="form-group row">
											<label for="startdate" class="col-md-12">Date of Steering Committee Meeting<span class="required">*</span></label>
											<div class="col-md-12"> 
										...
										<div class="form-group row ">
											<div class="col-md-12">
												<label for="was_review"  desk-review" id="was_review">Summary of relevant comments by SC</label>
												...
												<div>
													...
													<div >
														<label style="font-weight: 400;display: block;">
															...
															<span><b>Approve proposal for further review </b>(and initiate Advisory Board Review).</span><br>
														</label>
														<label style="font-weight: 400;display: block;">
