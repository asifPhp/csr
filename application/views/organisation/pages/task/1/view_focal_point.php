...
<div class="content-wrapper proposals">
	...
	if($project_cycle_data){
		...
		if(isset($project_cycle_data)){
			$additional_json = json_decode($project_cycle_data);
			   ...
			   <!-- general form elements -->
                ...
                <div class="box box-primary collapsed-box">
					<div class="box-header with-border" data-widget="collapse">
						...
						<h3 class="box-title">Focal Point Review</h3>
					</div>
					<div class="box-body">
						<h5>NGO Documents</h5>
						<div class="form-group row">
							<div  class="col-md-6 text-right">
								<label for="title">Project Assessment Doucuments required from the NGO for this cycle</label>
							</div>
							<div class="col-md-6"> 
								<span><?php if($ngo_doc_hiddien){echo $ngo_doc_hiddien;}?></span>
							</div>
						</div>
						
						<div class="form-group row">
							<div  class="col-md-6 text-right">
								<label for="title">Payment Documents required from the NGO for this cycle</label>
							</div>
							<div class="col-md-6"> 
								<span><?php if($ngo_payment_hidden){echo $ngo_payment_hidden;}?></span>
							</div>
						</div>
				...
				<div class="box box-primary collapsed-box">
					<div class="box-header with-border" data-widget="collapse">
						<i class="fa fa-plus btn btn-box-tool fa_plus"></i>
						<h3 class="box-title">NGO Cycle Documents</h3>
					</div>
					<div class="box-body">
						
						<div class="form-group row">
							<label for="title" class="col-md-6 text-right">Upload assessment documents for this donation/reporting cycle</label>
							<div class="col-md-6"> 
								<div class="table-responsive">
									<table id="blog_view_table" class=" table table-striped table-bordered table-hover" >
										<thead>
										...
										<tbody class="table_value">
											<?php if(!$csr_list){?>
												<td class="text-center" colspan="5" >No data Available</td>
											<?php }
												if($csr_list and $csr_list>0){
													foreach($csr_list as $row1){
													//var_dump($row1);
												?>
												<tr>
													<td  class="text-center"><?php echo $row1->csr_name;?></td>
													<td  class="text-center"><a  href="<?php echo base_url()?>uploads/<?php echo $row1->csr_file_value;?>"  target="_blank"><?php echo $row1->csr_file_value_actual;?></a></td>
