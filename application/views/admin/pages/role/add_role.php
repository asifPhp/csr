          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <?php if($is_permitted['is_list']){ ?>
			  	<a href="<?php echo base_url();?>admin/role/list" class="btn btn-default pull-right">List All</a>
			  <?php }?>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
...
$('document').ready(function(){
	...
	$('#role_form').validate({
        ...
        submitHandler: function (form) {
            ...
            $.post(APP_URL + 'admin/role/update_roles', {
                role_id: role_id,
            ...
            function (response) {
                ...
                if (response.status == 200) {
					...
					$("#err_add_plan").fadeTo(2000, 500).slideUp(500, function(){
						$('#err_add_plan').empty();
						window.location.href = APP_URL+'admin/role/list';
					});
			   } else {
                    $('#err_add_plan').empty();
